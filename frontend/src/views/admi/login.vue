        ...
        <v-layout align-left justify-left>
          ...
          <v-flex xs12 sm8 md8>
              <v-card class="elevation-12">
                <v-toolbar color="green darken-4" height="150">
                    <img src="../../assets/cafe.jpg" alt="" class="symbol">
                <v-toolbar-title class="font-weight-medium white--text display-1">Cooperativa_caf</v-toolbar-title>
                </v-toolbar>
